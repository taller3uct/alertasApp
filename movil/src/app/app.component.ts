...
export class MyApp {
  ...
  nombreUsuario;
  usuarioSub;
  constructor(platform: Platform, statusBar: StatusBar, splashScreen: SplashScreen, private _ajustes: AjustesProvider, private _login:LoginProvider, private menuCtrl:MenuController, private db:DbProvider, private screenOrientation: ScreenOrientation ) {
    platform.ready().then(() => {
